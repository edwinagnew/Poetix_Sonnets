...
def parse_args():
    ...
    parser.add_argument("--weight_decay", type=float, default=wd, help="Weight decay to use.")
...
def main():
    ...
    for epoch in range(args.num_train_epochs):
        ...
        logger.info(f"epoch {epoch}: eval perplexity: {eval_perplexity}, train perplexity: {train_perplexity}")
